 ...
 *   - view: {@link https://api.slack.com/methods/channels.view|channels.view}
 *
 */
...
/**
 * Provides all content you need to render a channel.
 * @see {@link https://api.slack.com/methods/channels.view|channels.view}
 *
 * @param {?} channel - Channel to view
 * @param {function=} optCb Optional callback, if not using promises.
 */
ChannelsFacet.prototype.view = function view(channel, optCb) {
  var requiredArgs = {
    channel: channel
  };

  return this.makeAPICall('channels.view', requiredArgs, null, optCb);
};
